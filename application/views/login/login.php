...
<div class="col-7 mx-auto mt-3">
    ...
    <input type="text" name="" placeholder="Ketik ID Jama'ah" class="form-control form-control-lg rounded-0 border-bottom-0 border-secondary">
    <input type="text" name="" placeholder="Ketik Password" class="form-control form-control-lg rounded-0 border-secondary">
    <input type="button" value="Masuk" class="btn btn-block btn-success btn-lg rounded-0">
</div>